...
# 项目路径   （找到自己的项目路径）
project_path = "/Users/kenchoi/Documents/test/HYJRefactoring/HYJRefactoring"

# 项目project.pbxproj文件路径 需要更新配置文件中的类名 （找到自己的项目project.pbxproj路径）
pbxpro_path = "/Users/kenchoi/Documents/test/HYJRefactoring/HYJRefactoring.xcodeproj/project.pbxproj"
...
def file_rename(file_path):
    ...
    new_path = os.path.join(root_path, filename.replace(
        pre_str, pre_to_str) + filetype)    # 拼接新路径
